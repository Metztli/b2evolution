...
{
    public $code = 'evo_mermaid';

    public $name = 'Mermaid Diagrams';
    ...
    public function RenderItemAsHtml(&$params)
    {
        ...
        $content = preg_replace_callback(
            '#(\<p>)?\<pre class="line-numbers">\<code class="language-mermaid">([\s\S]+?)</code>\</pre>(\</p>)?#i',
    ...
    {
        $content = preg_replace_callback(
            '#<pre class="line-numbers"><code class="language-mermaid">([\s\S]+?)?</code></pre>#i',
