...
class tag_snippet_plugin extends Plugin
{
    ...
    public function get_coll_setting_definitions(&$params)
    {
        ...
        return array_merge([
            'snippets' => [
                'label' => T_('Snippets'),
                'note' => sprintf(
                    T_('Please note snippets defined here override snippets with same tag defined in <a %s>general settings of the plugin "%s"</a>, and they may be overridden per widget by same tag.'),
    ...
    public function get_widget_param_definitions($params)
    {
        ...
        return [
            ...
            'snippets' => [
                'label' => T_('Snippets'),
                'note' => sprintf(
                    T_('Please note snippets defined here override snippets with same tag defined in <a %s>current collection plugin settings</a> and in <a %s>general settings of the plugin "%s"</a>.'),
    ...
    public function SkinTag(&$params)
    {
        ...
        if (empty($item_tags)) {	// Don't display this widget when current Item has no tags:
        ...
        if (empty($tag_snippets)) {	// Don't display this widget when no snippets are defined for tags of the current Item::
