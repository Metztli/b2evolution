...
{
    public $code = 'evo_shortcodes';

    public $name = 'Short Codes';
    ...
    public function AdminDisplayToolbar(&$params)
    {
        ...
        if (empty($Item) || $Item->is_intro() || ! $Item->get_type_setting('allow_breaks')) {	// Teaser and page breaks are not allowed for current item type and for all intro items:
            return false;
        }
