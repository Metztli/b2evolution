...
if (empty($redirect_to)) {	// If a redirect param was not defined on submitted form then redirect to site url:
    $redirect_to = $baseurl;
}
...
if ($current_User->must_accept_terms()) {	// Update settings of current user to mark as terms accepted:
