...
$is_pictured_page = in_array($disp, ['front', 'login', 'register', 'lostpassword', 'activateinfo', 'access_denied', 'access_requires_login']);
...
?>
        <div class="row">
            <div class="<?php if ($disp != 'front') {
                echo 'col-md-12';
            } else {
                echo 'col-md-6';
            } echo $disp == 'front' ? ' front_main_area' : ''; ?>">
