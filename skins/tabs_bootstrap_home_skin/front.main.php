...
?>
		...
		<?php
            // Item Teaser:
    foreach ($Skin->get_front_items() as $i => $Item) {	// Display images that are linked to this post:
        $Item->images([
...
?>
		...
		<?php
if ($Skin->get_setting('primary_area') == 'below_tab_text') {	// ------------------ "Front Page Main Area" CONTAINER EMBEDDED HERE -------------------
...
<div class="container">
	...
	<div class="row">
			...
			<?php
    if ($Skin->get_setting('primary_area') == 'below_tabs') {	// ------------------ "Front Page Main Area" CONTAINER EMBEDDED HERE -------------------
        // Display container and contents:
        widget_container('front_page_main_area', [
            // The following params will be used as defaults for widgets included in this container:
            'container_display_if_empty' => false, // If no widget, don't display container at all
