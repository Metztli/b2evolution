...
$is_pictured_page = in_array($disp, ['login', 'register', 'lostpassword', 'activateinfo', 'access_denied', 'access_requires_login', 'content_requires_login']);
...
if ($is_pictured_page) { // Display a picture from skin setting as background image
    ...
    if ($bg_File && $bg_File->exists()) { // If it exists in media folder
