            ...
            [
                ...
                'use_3_cols' => [
                    ...
                    'options' => [
                        ...
                        ['posts-default', sprintf( /* TRANS: position On disp=single or other disps */ T_('On %s'), '<code>disp=posts-default</code>'), 1],
...
*/
    ...
    public function is_3rd_right_column_layout()
    {
        ...
        if ($disp_detail == 'posts-default') {	// Category page:
            return (bool) $this->get_checklist_setting('use_3_cols', 'posts-default');
        }
    ...
    public function get_layout_class($place)
    {
        ...
        switch ($place) {
            case 'container':
                $r .= 'container';
                if ($disp == 'posts' || $this->is_3rd_right_column_layout()) {	// Layout with 3 columns on current page:
                    $r .= ' container-xxl';
                }
                break;
