...
if ($params['disp_title'] && $disp != 'single' && $disp != 'page') { // Don't display this on disp=single because there is already title header in h2
    $title_before = '<h2>';
    $title_after = '</h2>';
...
?>
	...
	<?php
if ($disp != 'front' && ! $Item->is_intro()) { // Don't display these data for intro posts
    ?>
