...
if (empty($hide_widget_container_menu)) { // Display this widget container only when it is not disabled
    ?>
	<div class="wptouch-menu-inner" rel="blog">
		<div id="menu-head">
			...
			<?php
                ...
                skin_container(NT_('Mobile: Navigation Menu'), [
    ...
    ?>
			...
			<?php
                ...
                // Display container and contents:
        skin_container(NT_('Mobile: Tools Menu'), [
            // The following params will be used as defaults for widgets included in this container:
	...
	<?php
        if (is_logged_in()) { // Display user menu
            ?>
