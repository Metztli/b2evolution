...
<header id="header" class="row<?php echo $Settings->get('site_skins_enabled') ? ' site_skins' : ''; ?>">
	...
	<div class="coll-xs-12 coll-sm-12 col-md-4 col-md-push-8">
		<?php
        if ($Skin->is_visible_container('page_top')) { // Display 'Page Top' widget container
            ?>
...
<?php
if ($Skin->is_visible_container('menu')) { // Display this widget container only when it is not disabled
    ?>
<nav class="row">
    ...
    if ($Skin->is_left_navigation_visible()) { // Display a left column with navigation only for several pages
		...
		<aside class="col-xs-12 col-md-3 pull-left">
			...
			<div id="evo_container__sidebar">
				...
				<?php
                    if ($Skin->is_visible_container('sidebar')) { // Display 'Sidebar' widget container
                        ?>
				...
				<?php
                        if ($Skin->is_visible_container('sidebar2')) { // Display 'Sidebar 2' widget container
                            ?>
