...
class jared_Skin extends Skin
{
    ...
    public function get_declared_containers()
    {
        ...
        return [
            ...
            'menu' => [NT_('Menu'), 15],
            'front_page_main_area' => [NT_('Front Page Area 1'), 40],
            'front_page_secondary_area' => [NT_('Front Page Area 2'), 41],
            'front_page_area_3' => [NT_('Front Page Area 3'), 42],
            'front_page_area_4' => [NT_('Front Page Area 4'), 43],
            'front_page_area_5' => [NT_('Front Page Area 5'), 44],
    ...
    public function get_param_definitions($params)
    {
        ...
        $r = array_merge([
            ...
            // ============ Page Top Section ============
            'pagetop_section_start' => [
                'layout' => 'begin_fieldset',
                'label' => T_('Page Top Settings'),
            ],
            'pagetop_button_bg_color' => [
                'label' => T_('Button background color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'pagetop_button_color' => [
            ...
            'section_1_navbar_text_color' => [
                'label' => T_('Top nav text color for transparent bg'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_1_image_file_ID' => [
            ...
            'section_1_text_color' => [
                'label' => T_('Normal text color'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_1_link_color' => [
                'label' => T_('Links color'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_1_muted_color' => [
                'label' => T_('Muted text color'),
                'defaultvalue' => '#F0F0F0',
                'type' => 'color',
            ],
            'section_1_icon_color' => [
                'label' => T_('Inverse icon color'),
                'defaultvalue' => '#CCCCCC',
                'type' => 'color',
            ],
            'section_1_button_bg_color' => [
                'label' => T_('Button background color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_1_button_color' => [
                'label' => T_('Button text color'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_1_text_align' => [
                ...
                'type' => 'radio',
                'options' => [
                    ['section_1_left', T_('Left')],
                    ['section_1_center', T_('Center')],
                    ['section_1_right', T_('Right')],
                ],
            ...
            'section_2_text_color' => [
                'label' => T_('Normal text color'),
                'defaultvalue' => '#adadad',
                'type' => 'color',
            ],
            'section_2_link_color' => [
                'label' => T_('Links color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_2_link_h_color' => [
                'label' => T_('Links hover color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_2_button_bg_color' => [
                'label' => T_('Button background color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_2_button_color' => [
                'label' => T_('Button text color'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_2_text_align' => [
                ...
                'type' => 'radio',
                'options' => [
                    ['section_2_left', T_('Left')],
                    ['section_2_center', T_('Center')],
                    ['section_2_right', T_('Right')],
                ],
            ...
            'section_3_text_color' => [
                'label' => T_('Normal text color'),
                'defaultvalue' => '#adadad',
                'type' => 'color',
            ],
            'section_3_link_color' => [
                'label' => T_('Links color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_3_link_h_color' => [
                'label' => T_('Links hover color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_3_button_bg_color' => [
                'label' => T_('Button background color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            ...
            'section_3_text_align' => [
                ...
                'type' => 'radio',
                'options' => [
                    ['section_3_left', T_('Left')],
                    ['section_3_center', T_('Center')],
                    ['section_3_right', T_('Right')],
                ],
            ...
            'section_4_title_color' => [
                'label' => T_('Title color'),
                'defaultvalue' => '#222222',
                'type' => 'color',
            ],
            'section_4_text_color' => [
                'label' => T_('Normal text color'),
                'defaultvalue' => '#adadad',
                'type' => 'color',
            ],
            'section_4_link_color' => [
                'label' => T_('Links color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_4_link_h_color' => [
                'label' => T_('Links hover color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_4_button_bg_color' => [
                'label' => T_('Button background color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_4_button_color' => [
                'label' => T_('Button text color'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_4_text_align' => [
                ...
                'type' => 'radio',
                'options' => [
                    ['section_4_left', T_('Left')],
                    ['section_4_center', T_('Center')],
                    ['section_4_right', T_('Right')],
                ],
            ...
            'section_5_text_color' => [
                'label' => T_('Normal text color'),
                'defaultvalue' => '#adadad',
                'type' => 'color',
            ],
            'section_5_link_color' => [
                'label' => T_('Links color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_5_link_h_color' => [
                'label' => T_('Links hover color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_5_button_bg_color' => [
                'label' => T_('Button background color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_5_button_color' => [
                'label' => T_('Button text color'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_5_text_align' => [
                ...
                'type' => 'radio',
                'options' => [
                    ['section_5_left', T_('Left')],
                    ['section_5_center', T_('Center')],
                    ['section_5_right', T_('Right')],
                ],
            ...
            'section_6_navbar_text_color' => [
                'label' => T_('Top nav text color for transparent bg'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_6_image_file_ID' => [
            ...
            'section_6_text_color' => [
                'label' => T_('Normal text color'),
                'defaultvalue' => '#adadad',
                'type' => 'color',
            ],
            'section_6_link_color' => [
                'label' => T_('Links color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_6_link_h_color' => [
                'label' => T_('Links hover color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_6_button_bg_color' => [
                'label' => T_('Button background color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            ...
            'section_6_text_align' => [
                ...
                'type' => 'radio',
                'options' => [
                    ['section_6_left', T_('Left')],
                    ['section_6_center', T_('Center')],
                    ['section_6_right', T_('Right')],
                ],
            ...
            'section_7_navbar_text_color' => [
                'label' => T_('Top nav text color for transparent bg'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_7_image_file_ID' => [
                'label' => T_('Background image'),
                'type' => 'fileselect',
            ...
            'section_7_text_color' => [
                'label' => T_('Normal text color'),
                'defaultvalue' => '#adadad',
                'type' => 'color',
            ],
            'section_7_link_color' => [
                'label' => T_('Links color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_7_link_h_color' => [
                'label' => T_('Links hover color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_7_button_bg_color' => [
                'label' => T_('Button background color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_7_button_color' => [
                'label' => T_('Button text color'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_7_text_align' => [
                ...
                'type' => 'radio',
                'options' => [
                    ['section_7_left', T_('Left')],
                    ['section_7_center', T_('Center')],
                    ['section_7_right', T_('Right')],
                ],
            ...
            'section_access_navbar_text_color' => [
                'label' => T_('Top nav text color for transparent bg'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            ...
            'section_access_bg_color' => [
                'label' => T_('Background color'),
                'note' => T_('This color will be used if Background image is not set or does not exist.'),
                'defaultvalue' => '#333333',
                'type' => 'color',
            ],
            'section_pictured_end' => [
                'layout' => 'end_fieldset',
            ],
            ...
            'section_oth_navbar_text_color' => [
                'label' => T_('Top nav text color for transparent bg'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_oth_image_file_ID' => [
                'label' => T_('Background image'),
                'type' => 'fileselect',
                'initialize_with' => 'shared/global/monument-valley/john-ford-point.jpg',
                'thumbnail_size' => 'fit-320x320',
            ],
            'section_oth_bg_color' => [
                'label' => T_('Background color'),
                'note' => T_('This color will be used if Background image is not set or does not exist.'),
                'defaultvalue' => '#333333',
                'type' => 'color',
            ],
            'section_oth_cont_width' => [
                'label' => T_('Maximum content width'),
                'note' => 'px. ' . T_('Set the ammount of maximum width for the content in this section.') . ' <strong>' . T_('Maximum value is') . ' 1170px.</strong>',
                'defaultvalue' => '1170',
                'type' => 'integer',
            ...
            'section_oth_title_color' => [
                'label' => T_('Title color'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_oth_text_color' => [
                'label' => T_('Normal text color'),
                'defaultvalue' => '#adadad',
                'type' => 'color',
            ],
            'section_oth_link_color' => [
                'label' => T_('Links color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_oth_link_h_color' => [
                'label' => T_('Links hover color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_oth_button_bg_color' => [
                'label' => T_('Button background color'),
                'defaultvalue' => '#318780',
                'type' => 'color',
            ],
            'section_oth_button_color' => [
                'label' => T_('Button text color'),
                'defaultvalue' => '#FFFFFF',
                'type' => 'color',
            ],
            'section_oth_text_align' => [
                'label' => T_('Align text'),
                'note' => '',
                'type' => 'radio',
                'options' => [
                    ['section_oth_left', T_('Left')],
                    ['section_oth_center', T_('Center')],
                    ['section_oth_right', T_('Right')],
                ],
            ...
            'footer_text_align' => [
                ...
                'options' => [
                    ['footer_left', T_('Left')],
                    ['footer_center', T_('Center')],
                    ['footer_right', T_('Right')],
                ],
    ...
    public function display_init()
    {
        ...
        if ($this->get_setting('nav_bg_transparent')) {	// If "Transparent background" is enabled:
            // Background color:
            ...
            if (in_array($disp, ['front', 'login', 'register', 'lostpassword', 'activateinfo', 'access_denied', 'access_requires_login'])) {	// Text/Links color:
                $this->dynamic_style_rule('nav_links_color', '@media (max-width: 1024px) { .affix-top a { color: $setting_value$ !important } }');
            }
        } else {	// If "Transparent background" is disabled:
            // Background color:
            $this->dynamic_style_rule('nav_bg_color', '.navbar { background-color: $setting_value$ }');
        }
        // Title font size:
        $this->dynamic_style_rule('nav_colltitle_size', '.navbar.main-header-navigation .navbar-brand > h3 a { font-size: $setting_value$ }', [
            'suffix' => 'px',
        ]);
        // Links font size:
        $this->dynamic_style_rule(
        ...
        if (in_array($disp, ['front', 'login', 'register', 'lostpassword', 'activateinfo', 'access_denied', 'access_requires_login'])) {
            ...
            if ($this->get_setting('section_1_display')) {
                if ($this->get_setting('nav_bg_transparent')) {	// Top nav text color for transparent bg:
                    $this->dynamic_style_rule('section_1_navbar_text_color', '@media (min-width: 1025px) { .affix-top a { color: $setting_value$ !important } }');
                }
                // Background image:
                $this->dynamic_style_rule('section_1_image_file_ID', '.evo_container__front_first_section { background-image: $setting_value$ }', [
                    'type' => 'image_file',
                ]);
                // Background color:
                $this->dynamic_style_rule('section_1_bg_color', '.evo_container__front_first_section { background-color: $setting_value$ }');
                // Maximum content width:
                $this->dynamic_style_rule('section_1_cont_width', 'body.pictured.disp_front .container.main_page_wrapper { max-width: $setting_value$ }', [
                    'suffix' => 'px',
                ]);
                ...
                // Align text:
                $this->dynamic_style_rule('section_1_text_align', '.evo_container__front_page_main_area { text-align: $setting_value$ }', [
                    'options' => [
                        'section_1_left' => 'left',
            ...
            if ($this->get_setting('section_2_display')) {
                // Background image:
                $this->dynamic_style_rule('section_2_image_file_ID', '.evo_container__front_page_secondary_area { background-image: $setting_value$ }', [
                    'type' => 'image_file',
                ]);
                // Background color:
                $this->dynamic_style_rule('section_2_bg_color', '.evo_container__front_page_secondary_area { background-color: $setting_value$ }');
                // Maximum content width:
                $this->dynamic_style_rule('section_2_cont_width', '.evo_container__front_page_secondary_area > .container { max-width: $setting_value$ }', [
                    'suffix' => 'px',
                ]);
                // Title color:
                ...
                // Align text:
                $this->dynamic_style_rule('section_2_text_align', '.evo_container__front_page_secondary_area { text-align: $setting_value$ }', [
                    'options' => [
                        'section_2_left' => 'left',
            ...
            if ($this->get_setting('section_3_display')) {
                // Background image:
                $this->dynamic_style_rule('section_3_image_file_ID', '.evo_container__front_page_area_3 { background-image: $setting_value$ }', [
                    'type' => 'image_file',
                ]);
                // Background color:
                $this->dynamic_style_rule('section_3_bg_color', '.evo_container__front_page_area_3 { background-color: $setting_value$ }');
                // Maximum content width:
                $this->dynamic_style_rule('section_3_cont_width', '.evo_container__front_page_area_3 > .container { max-width: $setting_value$ }', [
                    'suffix' => 'px',
                ]);
                // Title color:
                ...
                // Align text:
                $this->dynamic_style_rule('section_3_text_align', '.evo_container__front_page_area_3 { text-align: $setting_value$ }', [
                    'options' => [
                        'section_3_left' => 'left',
            ...
            if ($this->get_setting('section_4_display')) {
                // Background image:
                $this->dynamic_style_rule('section_4_image_file_ID', '.evo_container__front_page_area_4 { background-image: $setting_value$ }', [
                    'type' => 'image_file',
                ]);
                // Background color:
                $this->dynamic_style_rule('section_4_bg_color', '.evo_container__front_page_area_4 { background-color: $setting_value$ }');
                // Maximum content width:
                $this->dynamic_style_rule('section_4_cont_width', '.evo_container__front_page_area_4 > .container { max-width: $setting_value$ }', [
                    'suffix' => 'px',
                ]);
                // Title color:
                ...
                // Align text:
                $this->dynamic_style_rule('section_4_text_align', '.evo_container__front_page_area_4 { text-align: $setting_value$ }', [
                    'options' => [
                        'section_4_left' => 'left',
            ...
            if ($this->get_setting('section_5_display')) {
                // Background image:
                $this->dynamic_style_rule('section_5_image_file_ID', '.evo_container__front_page_area_5 { background-image: $setting_value$ }', [
                    'type' => 'image_file',
                ]);
                // Background color:
                $this->dynamic_style_rule('section_5_bg_color', '.evo_container__front_page_area_5 { background-color: $setting_value$ }');
                // Maximum content width:
                $this->dynamic_style_rule('section_5_cont_width', '.evo_container__front_page_area_5 > .container { max-width: $setting_value$ }', [
                    'suffix' => 'px',
                ]);
                // Title color:
                ...
                // Align text:
                $this->dynamic_style_rule('section_5_text_align', '.evo_container__front_page_area_5 { text-align: $setting_value$ }', [
                    'options' => [
                        'section_5_left' => 'left',
        ...
        if ($disp == 'page' || $disp == 'single') {
            ...
            // Background image:
            $this->dynamic_style_rule('section_6_image_file_ID', '.evo_container__standalone_page_area_6 { background-image: $setting_value$ }', [
                'type' => 'image_file',
            ]);
            // Background color:
            $this->dynamic_style_rule('section_6_bg_color', '.evo_container__standalone_page_area_6 { background-color: $setting_value$ }');
            // Maximum content width:
            $this->dynamic_style_rule('section_6_cont_width', '.evo_container__standalone_page_area_6 > .container { max-width: $setting_value$ }', [
                'suffix' => 'px',
            ]);
            // Title color:
            ...
            // Align text:
            $this->dynamic_style_rule('section_6_text_align', '.evo_container__standalone_page_area_6, .evo_container__single_page_cover { text-align: $setting_value$ }', [
                'options' => [
                    'section_6_left' => 'left',
        ...
        if ($disp == 'msgform' || $disp == 'threads' || $disp == 'messages') {
            ...
            // Background image:
            $this->dynamic_style_rule('section_7_image_file_ID', '.evo_container__standalone_page_area_7 { background-image: $setting_value$ }', [
                'type' => 'image_file',
            ]);
            // Background color:
            $this->dynamic_style_rule('section_7_bg_color', '.evo_container__standalone_page_area_7 { background-color: $setting_value$ }');
            // Maximum content width:
            $this->dynamic_style_rule('section_7_cont_width', '.evo_container__standalone_page_area_7 > .container { max-width: $setting_value$ }', [
                'suffix' => 'px',
            ]);
            // Title color:
            ...
            // Align text:
            $this->dynamic_style_rule('section_7_text_align', '.evo_container__standalone_page_area_7 { text-align: $setting_value$ }', [
                'options' => [
                    'section_7_left' => 'left',
        ...
        if (in_array($disp, ['login', 'register', 'lostpassword', 'activateinfo', 'access_denied', 'access_requires_login'])) {
            if ($this->get_setting('nav_bg_transparent')) {
                // Top nav text color for transparent bg:
            ...
            // Background image:
            $this->dynamic_style_rule('section_access_image_file_ID', '.restricted_access_disps { background-image: $setting_value$ }', [
                'type' => 'image_file',
            ]);
            // Background color:
        ...
        if ($this->get_setting('nav_bg_transparent') &&
            ! in_array($disp, ['front', 'login', 'register', 'lostpassword', 'activateinfo', 'access_denied', 'access_requires_login', 'msgform', 'threads', 'page'])) {
            // Top nav text color for transparent bg:
            $this->dynamic_style_rule('section_oth_navbar_text_color', '@media (min-width: 1025px) { .affix-top a { color: $setting_value$ !important } }');
        }
        // Background image:
        $this->dynamic_style_rule('section_oth_image_file_ID', '.evo_container__standalone_page_area_oth { background-image: $setting_value$ }', [
            'type' => 'image_file',
        ]);
        // Background color:
        $this->dynamic_style_rule('section_oth_bg_color', '.evo_container__standalone_page_area_oth { background-color: $setting_value$ }');
        // Maximum content width:
        $this->dynamic_style_rule('section_oth_cont_width', '.evo_container__standalone_page_area_oth > .container { max-width: $setting_value$ }', [
            'suffix' => 'px',
        ]);
        // Title color:
        ...
        // Align text:
        $this->dynamic_style_rule('section_oth_text_align', '.evo_container__standalone_page_area_oth { text-align: $setting_value$ }', [
            'options' => [
        ...
        // Align text:
        $this->dynamic_style_rule('footer_text_align', '.footer_wrapper { text-align: $setting_value$ }', [
            'options' => [
                'footer_left' => 'left',
