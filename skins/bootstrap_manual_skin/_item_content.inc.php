...
$params = array_merge([
    ...
    'footer_text_end' => '</div>',
], (array)$params); // Jose/Metztli IT 02-11-2024 casted second argument $params to array as skin complained of being string.

// Determine content mode to use..
if ($Item->is_intro()) {	// Content mode for intro items:
...
} else {	// Content mode for normal(not intro) items:
