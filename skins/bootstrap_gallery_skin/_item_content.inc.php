...
$params = array_merge([
    ...
    'content_start_full' => in_array($disp_detail, ['help', 'register']) ? '' : '<section class="evo_post__full panel panel-default">',		// In case of full display
    ...
    'content_end_full' => in_array($disp_detail, ['help', 'register']) ? '' : '</section>',
    ...
    'content_start_full_text' => in_array($disp_detail, ['help', 'register']) ? '' : '<div class="evo_post__full_text panel-body">',
    'content_end_full_text' => in_array($disp_detail, ['help', 'register']) ? '' : '</div>',
    ...
    'footer_text_end' => '</div>',
], (array)$params); // Jose/Metztli IT 02-09-2024 casted second argument $params to array as skin complained of being string.
...
switch ($content_mode) {
    ...
    default:
        ...
        if (! in_array($disp_detail, ['help', 'register'])) {	// Title and number of photos in album
