 ...
 */
if (! function_exists('NT_')) {	// A workaround for 'reset' action in locales.ctrl.php
    function NT_($string)
    {
        return $string;
    }
...
if (version_compare(phpversion(), '5.6', '>=')) {	// In case of php version greater than 5.6 set the default charset to UTF-8
