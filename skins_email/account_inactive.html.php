...
if (! empty($login_Blog)) { // Use special blog for login/lost password actions if it is defined
    $login_url = $login_Blog->get('loginurl', [
        'glue' => '&',
    ]);
    $lostpassword_url = $login_Blog->get('lostpasswordurl', [
        'glue' => '&',
    ]);
} else { // Use standard login/lost password urls
