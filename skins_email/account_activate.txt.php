...
if ($Settings->get('validation_process') == 'easy') { // ---- EASY activation ---- //
    ...
    if (! empty($params['already_received_messages'])) { // add already received message list to email body
