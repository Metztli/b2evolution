...
$Form->select_country('rgn_ctry_ID', $edited_Region->ctry_ID, $CountryCache, TB_('Country'), [
    'allow_none' => true,
    'required' => true,
]);

$Form->text_input('rgn_code', $edited_Region->code, 6, TB_('Code'), '', [
    'maxlength' => 6,
    'required' => true,
]);

$Form->text_input('rgn_name', $edited_Region->name, 40, TB_('Name'), '', [
    'maxlength' => 40,
    'required' => true,
]);
