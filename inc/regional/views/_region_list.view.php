...
if ($c > 0) {	// We want to filter on search country:
...
if (check_user_perm('options', 'edit', false)) {
    ...
    $Results->global_icon(
        T_('Import regions from CSV file ...'),
        'new',
