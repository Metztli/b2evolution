...
$Form->text_input('ctry_code', $edited_Country->code, 2, TB_('Code'), '', [
    'maxlength' => 2,
    'required' => true,
]);

$Form->text_input('ctry_name', $edited_Country->name, 40, TB_('Name'), '', [
    'maxlength' => 40,
    'required' => true,
]);
...
$Form->select_input_object('ctry_curr_ID', $edited_Country->curr_ID, $CurrencyCache, TB_('Default Currency'), [
    'allow_none' => true,
]);
