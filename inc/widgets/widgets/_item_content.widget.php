...
class item_content_Widget extends ComponentWidget
{
    ...
    public function display($params)
    {
        ...
        if (isset($this->disp_params['widget_coll_item_content_params'])) {	// The new correct stuff gets precedence over the old stuff:
        ...
        if (! empty($template_code) &&
            ! ($content_Template = &$TemplateCache->get_by_code($template_code, false, false))) {	// Display error when no or wrong template for content display:
        ...
        if (! empty($content_Template)) {	// Render Item content by Easy Template:
            echo render_template_code($template_code, $widget_item_content_params);
        } else {	// Use PHP Template to display content:
