...
class subcontainer_Widget extends ComponentWidget
{
    ...
    public function dbupdate()
    {
        ...
        if ($this->get_param('container') == '!create_new') {	// This is a request to create new sub-container:
            $new_container_code = $this->create_auto_subcontainer();
            if ($new_container_code === false) {	// Stop updating if new container cannot be created:
                $result = false;
            } else {	// Use new created sub-container for this updating widget:
     ...
     * @return object|false
     */
    public function &get_sub_WidgetContainer()
    {
        // Get container type "coll"/"shared" and real container code from stored value:
