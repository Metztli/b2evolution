...
class coll_logo_Widget extends ComponentWidget
{
        ...
        $r = array_merge([
            ...
            'check_file' => [
                ...
                'options' => [
                    ...
                    ['title', T_('Check -> if image doesn\'t exist, display the collection title instead.')]],
                'defaultvalue' => 'title',
            ],
    ...
    public function display($params)
    {
        ...
        if ($check_file == 'title' && empty($image_url)) { // Logo file doesn't exist, Display a collection title because widget setting requires this:
            $title .= $Blog->get('name');
        } else {
