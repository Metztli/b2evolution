 ...
 */
function get_default_widgets($coll_type = '', $context = [])
{
    ...
    $default_widgets['header'] = [
        [1, 15000, 'coll_title'],
        [2, 15000, 'coll_tagline'],
    ];

    /* Menu */
    $default_widgets['menu'] = [
        ...
        [
            ...
            'mustread_menu_link',
            'is_pro' => true,
            'coll_type' => '-main,minisite',
        ],
        [
            8,
            15000,
            'basic_menu_link',
            'coll_type' => 'forum,group',
            'params' => [
                'link_type' => 'flagged',
                'link_text' => T_('Flagged topics'),
            ],
        ],
        [
            8,
        ...
        [
            ...
            15000,
            'basic_menu_link',
            'install' => $context['init_as_blog_b'],
            'params' => [
                'link_type' => 'recentposts',
                'link_text' => T_('News'),
            ],
        ],
        [
        ...
        [
            ...
            'coll_type' => 'forum',
            'params' => [
                'link_type' => 'latestcomments',
                'link_text' => T_('Latest replies'),
            ],
        ],
        [
            13,
    ...
    /* Item List */
    $default_widgets['item_list'] = [
        [5,  16150, 'request_title'],
        [10, 15190, 'coll_item_list_pages'],
    ];

    /* Item in List */
    $default_widgets['item_in_list'] = [
        [10, 15190, 'item_title'],
        [
            20,
            15190,
        ...
        [40, 15720, 'item_content'],
        [
            50,
            15760,
            'item_info_line',
            'coll_type' => '-manual,forum',
            'params' => [
                'template' => 'item_details_feedback_link',
            ],
        ],
    ];

    /* Item Single Header */
    $default_widgets['item_single_header'] = [
        [
            4,
            15190,
            'item_next_previous',
            'coll_type' => '-manual,minisite',
        ],
        [5, 15190, 'item_title'],
        [
            10,
            ...
            'coll_type' => 'forum,group',
            'params' => [
                'template' => 'item_details_infoline_forums',
            ],
        ],
        [
            20,
    ...
    $default_widgets['item_single'] = [
        ...
        [
            ...
            15000,
            'item_tags',
            'coll_type' => '-forum,group,manual',
            'install' => ! $context['init_as_blog_a'] && ! $context['init_as_events'],
        ],
        [
            25,
            15000,
        ...
        [
            ...
            15000,
            'item_small_print',
            'install' => $context['init_as_blog_a'],
            'params' => [
                'template' => 'item_details_smallprint_standard',
            ],
        ],
        [
            40,
            ...
            'coll_type' => 'manual',
            'params' => [
                'template' => 'item_details_revisions',
            ],
        ],
        [
            50,
    ...
    /* Item Page */
    $default_widgets['item_page'] = [
        [10, 15000, 'item_content'],
        [15, 15000, 'item_attachments'],
        [50, 15000, 'item_seen_by'],
        [
            60,
            15000,
            'item_vote',
    ...
    /* Comment List */
    $default_widgets['comment_list'] = [
        [5, 16130, 'request_title'],
    ];

    /* Comment Area */
    $default_widgets['comment_area'] = [
        [
            5,
            15300,
            'fin_contrib',
        ...
        [10, 15300, 'item_comment_form'],
        [20, 15300, 'item_comment_notification'],
        [30, 15300, 'coll_item_notification'],
        [40, 15300, 'coll_comment_notification'],
        [50, 15300, 'item_comment_feed_link'],
    ];

    /* Sidebar Single */
    $default_widgets['sidebar_single'] = [
        [
            1,
            15000,
            'item_workflow',
    ...
    $default_widgets['page_top'] = [
        ...
        [20, 15450, 'coll_locale_switch'],
    ];

    /* Sidebar */
    if ($coll_type == 'manual') {
        $default_widgets['sidebar'] = [
            'coll_type' => 'manual',
            [
                10,
                15000,
        ...
        if ($context['init_as_home']) {	// Advertisements, Install only for collection #1 home collection:
        ...
        $default_widgets['sidebar'] = [
            [
                ...
                'coll_type' => '-forum',
                'install' => $context['install_test_features'],
            ],
            [
                10,
                15000,
            ...
            [
                ...
                'evo_Calr',
                'type' => 'plugin',
                'install' => ($install_not_forum && $context['current_coll_ID'] > $context['coll_blog_a_ID']),
            ],
            [
                40,
                15000,
            ...
            [
                ...
                15000,
                'coll_item_list',
                'install' => $install_not_forum && $context['init_as_home'],
                'params' => [
            ...
            [
                ...
                15000,
                'coll_media_index',
                'install' => ($install_not_forum && ! $context['init_as_blog_b']),
                'params' => [
                    'title' => 'Random photo',
            ...
            [
                ...
                15000,
                'coll_item_list',
                'install' => ($install_not_forum && ($context['init_as_blog_a'] || $context['init_as_blog_b'])),
                'params' => [
            ...
            [100, 15000, 'coll_xml_feeds'],
            [110, 15000, 'mobile_skin_switcher'],
        ];
    }
    ...
    $default_widgets['front_page_main_area'] = [
        [
            1,
            15000,
            'coll_title',
    ...
    /* Front Page Column A */
    $default_widgets['front_page_column_a'] = [
        'type' => 'sub',
    ...
    /* Front Page Column B */
    $default_widgets['front_page_column_b'] = [
        'type' => 'sub',
    ...
    $default_widgets['front_page_secondary_area'] = [
        [
            10,
            15000,
            'org_members',
    ...
    /* Chapter Main Area */
    $default_widgets['chapter_main_area'] = [
        'coll_type' => 'manual',
        [
            10,
            15320,
        ...
        [
            ...
            'params' => [
                'blog_ID' => '-',
                'display_when' => 'no_intro',
            ],
        ],
        [40, 15730, 'cat_content_list'],
    ];

    /* 404 Page */
    $default_widgets['404_page'] = [
        [10, 15000, 'page_404_not_found'],
        [20, 15000, 'coll_search_form'],
        [30, 15000, 'coll_tag_cloud'],
    ];

    /* Login Required */
    $default_widgets['login_required'] = [
        [
            10,
            15000,
            'content_block',
            'params' => [
                'item_slug' => 'login-required',
            ],
        ],
        [
            20,
    ...
    /* Access Denied */
    $default_widgets['access_denied'] = [
        [
            10,
            15000,
            'content_block',
            'params' => [
                'item_slug' => 'access-denied',
            ],
        ],
    ];

    /* Help */
    $default_widgets['help'] = [
        [
            10,
            15000,
            'content_block',
    ...
    /* Register */
    $default_widgets['register'] = [
        [10, 15000, 'user_register_standard'],
        [
            20,
            15000,
            'content_block',
    ...
    /* Mobile Footer */
    $default_widgets['mobile_footer'] = [
        'skin_type' => 'mobile',
        [10, 15000, 'coll_longdesc'],
        [20, 15000, 'mobile_skin_switcher'],
    ];

    /* Mobile Navigation Menu */
    $default_widgets['mobile_navigation_menu'] = [
        'skin_type' => 'mobile',
        [10, 15000, 'coll_page_list'],
        [
            20,
            15000,
            'basic_menu_link',
    ...
    /* Mobile Tools Menu */
    $default_widgets['mobile_tools_menu'] = [
        'skin_type' => 'mobile',
        [
            10,
            15000,
    ...
    /* User Profile - Left */
    $default_widgets['user_profile_left'] = [
    ...
    /* User Profile - Right */
    $default_widgets['user_profile_right'] = [
        // User Profile Picture(s):
        [
            10,
            15230,
    ...
    $default_widgets['user_page_reputation'] = [
        'type' => 'sub',
    ...
    /* Search Area */
    $default_widgets['search_area'] = [
        [5,  16140, 'request_title'],
        [
            10,
            15960,
            'coll_search_form',
    ...
    $default_widgets['navigation_hamburger'] = [
        'type' => 'shared',
    ...
    $tmp_widget_order = 20;
    if (! empty($installed_collection_info_pages) && is_array($installed_collection_info_pages)) {	// Install additional menu items for each page from info/shared collection:
    ...
    $default_widgets['navigation_hamburger'] = array_merge($default_widgets['navigation_hamburger'], [
        [
            $tmp_widget_order + 10,
            15260,
            'basic_menu_link',
    ...
    /* Main Navigation */
    $default_widgets['main_navigation'] = [
        'type' => 'shared-sub',
    ...
    $tmp_widget_order = intval($tmp_widget_order / 10) * 10;
    $default_widgets['main_navigation'] = array_merge($default_widgets['main_navigation'], [
        [
            $tmp_widget_order + 10,
            15260,
            'basic_menu_link',
    ...
    /* Right Navigation */
    $default_widgets['right_navigation'] = [
        'type' => 'shared-sub',
    ...
    /* Marketing Popup */
    $default_widgets['marketing_popup'] = [
        'type' => 'shared',
        'name' => NT_('Marketing Popup'),
        [10, 15310, 'user_register_quick'],
    ];

    // **** PAGE CONTAINERS ***** //

    if (isset($installed_collection_info_pages['widget_page'])) {	// Install page containers only with defined item ID:
        /* Widget Page Section 1 */
        $default_widgets['widget_page_section_1'] = [
            'coll_type' => 'main',
            'type' => 'page',
        ...
        $default_widgets['widget_page_section_2'] = [
            'coll_type' => 'main',
            'type' => 'page',
            'name' => NT_('Widget Page Section 2'),
            'order' => 20,
            'item_ID' => $installed_collection_info_pages['widget_page'],
            [10, 15000, 'org_members'],
        ];

        /* Widget Page Section 3 */
        $default_widgets['widget_page_section_3'] = [
            'coll_type' => 'main',
            'type' => 'page',
 ...
 */
function get_default_widgets_by_container($container_code, $coll_type = '', $context = [])
{
...
function install_new_default_widgets($new_container_code, $new_widget_codes = '*', $coll_ID = null, $skin_type = 'normal')
{
    ...
    if (function_exists('upg_init_environment')) {	// We're going to need some environment in order to init item type cache and create item:
    ...
    switch ($container_type) {
        ...
        case 'page':
            ...
            if ($coll_ID === null) {	// Load all collections:
                $BlogCache->load_all();
            } else {	// Load a requested collection:
                $BlogCache->load_list([$coll_ID]);
            }

            if (empty($BlogCache->cache)) {	// No collections in DB:
                break;
            }
            ...
            foreach ($BlogCache->cache as $widget_Blog) {
                ...
                if (isset($container_widgets['coll_type']) &&
                    ! is_allowed_option($widget_Blog->get('type'), $container_widgets['coll_type'])) {	// Skip container because it should not be installed for the given collection kind:
                    continue;
                }

                if (! isset($coll_containers[$new_container_code]) &&
                    ($container_type == 'sub' || $container_type == 'page')) {	// Initialize sub-container and page containers data in order to install it below:
                    $coll_containers[$new_container_code] = [
                    ...
                    if ($sub_WidgetContainer = &$WidgetContainerCache->get_by_coll_skintype_code($widget_Blog->ID, $skin_type, $new_container_code)) {	// Set ID if widget container already exists for the collection:
                        $coll_containers[$new_container_code]['ID'] = $sub_WidgetContainer->ID;
                    }
                }

                if ($container_widgets !== false) {	// If the requested container has at least one widget:
                    if (! isset($coll_containers[$new_container_code])) {	// Skip container which is not supported by current collection's skin:
                        continue;
                    }

                    $coll_container = $coll_containers[$new_container_code];

                    if (! isset($coll_container['ID'])) {	// Create new container if it is not installed yet:
                        if (! isset($coll_container[0]) || ! isset($coll_container[1])) {	// We cannot create a container without name and order, Skip it:
                            continue;
                        }
                        // Insert new widget container into DB:
                        $new_container_fields = [
                        ...
                        if ($container_type == 'page' && isset($container_widgets['item_ID'])) {	// Page container has an additional field for Item:
                    ...
                    } elseif (! isset($widget_orders_in_containers)) {	// For existing containers we should get all widget orders in order to avoid duplicate error on insert new widgets:
                    ...
                    if (! isset($widget_orders_in_containers)) {
                        $widget_orders_in_containers = [];
                    }
                    if (! isset($widget_orders_in_containers[$coll_container['ID']])) {
                        $widget_orders_in_containers[$coll_container['ID']] = [];
                    }
                    ...
                    foreach ($container_widgets as $key => $widget) {
                        ...
                        if (! is_allowed_option($widget[2], $new_widget_codes)) {	// Skip not requested widget:
                            continue;
                        }

                        if (! empty($upgrade_db_version) && $widget[1] != $upgrade_db_version) {	// Skip widget because it must be installed only for the specific upgrade block:
                            continue;
                        }
                        ...
                        if (isset($widget['coll_type']) && ! is_allowed_option($widget_Blog->get('type'), $widget['coll_type'])) {	// Skip widget because it should not be installed for the given collection kind:
                            continue;
                        }
                        ...
                        if (isset($widget['coll_ID']) && ! is_allowed_option($widget_Blog->ID, $widget['coll_ID'])) {	// Skip widget because it should not be installed for the given collection ID:
                            continue;
                        }
                        ...
                        while (in_array($widget_order, $widget_orders_in_containers[$coll_container['ID']])) {	// Search next free order inside the container:
                            $widget_order++;
                        }
                        if ($widget_order != $widget[0]) {	// Update widget order in cache:
        ...
        case 'shared-sub':
            ...
            if (! isset($cache_installed_shared_containers)) {	// Load all shared containers in cache global array once:
            ...
            if (isset($container_widgets['name'])) {	// Handle special array item with container data:
                if (! isset($cache_installed_shared_containers[$new_container_code])) {	// Insert new shared container:
                    $insert_result = $DB->query(
                        'INSERT INTO T_widget__container( wico_code, wico_skin_type, wico_name, wico_coll_ID, wico_order, wico_main ) VALUES '
            ...
            if (! isset($cache_installed_shared_containers[$new_container_code])) {	// Skip container which is not installed as shared:
                break;
            }
    ...
    if (! empty($new_widgets_insert_sql_rows)) {	// Insert the widget rows by single SQL query:
...
function is_installed_widget($widget_code, $container_code, $coll_ID = null)
{
    ...
    if (! isset($evo_installed_widgets_by_container_collection) ||
        ...
        $evo_installed_widgets_by_container_collection = [];
    }

    if (! isset($evo_installed_widgets_by_container_collection[$container_code])) {	// Get widget and store in global cache array:
        global $DB;
        ...
        foreach ($widgets as $widget) {
            ...
            if (! isset($evo_installed_widgets_by_container_collection[$container_code][$widget_coll_ID])) {
                $evo_installed_widgets_by_container_collection[$container_code][$widget_coll_ID] = [];
            }
...
function &get_WidgetContainer_by_coll_skintype_fieldset($coll_ID, $skin_type, $container_fieldset_id)
{
    ...
    if (substr($container_fieldset_id, 0, 10) == 'wico_code_') { // The widget contianer fieldset id was given by the container code because probably it was not created in the database yet
        ...
        if (! $WidgetContainer) { // The skin container didn't contain any widget before, and it was not saved in the database
    ...
    } elseif (substr($container_fieldset_id, 0, 8) == 'wico_ID_') { // The widget contianer fieldset id contains the container database ID
        $container_ID = substr($container_fieldset_id, 8);
        $WidgetContainer = &$WidgetContainerCache->get_by_ID($container_ID);
    } else { // The received fieldset id is not valid
...
function insert_shared_widgets($skin_type)
{
    ...
    $shared_widgets_insert_sql_rows = [];
    $shared_containers = [];
    $shared_widgets = [];
    ...
    foreach ($existing_widgets as $existing_widget) {
        ...
        if (! isset($shared_widgets[$existing_widget->wico_ID])) {
            $shared_widgets[$existing_widget->wico_ID] = [];
        }
    ...
    foreach ($default_widgets as $wico_code => $container_widgets) {
        if (! isset($container_widgets['type']) ||
            ! in_array($container_widgets['type'], ['shared', 'shared-sub'])) {	// Skip not shared container:
            continue;
        }
        ...
        if (isset($container_widgets['name'])) {	// Handle special array item with container data:
            if (! isset($shared_containers[$wico_code])) {	// Insert new shared container:
                $insert_result = $DB->query(
                    'INSERT INTO T_widget__container ( wico_code, wico_skin_type, wico_name, wico_coll_ID, wico_order, wico_main ) VALUES '
        ...
        if (! isset($shared_containers[$wico_code])) {	// Skip container which is not installed as shared:
            continue;
        }
        ...
        foreach ($container_widgets as $key => $widget) {
            ...
            if (isset($shared_widgets[$wico_id][$widget[0]])) {	// Skip the widget because a widget was already installed for the container with same order:
                continue;
            }
    ...
    if (! empty($shared_widgets_insert_sql_rows)) {	// Insert the widget records by single SQL query:
 ...
 * @param array Params
 */
function display_container($WidgetContainer, $params = [])
{
    ...
    if ($mode != 'customizer') {	// Use simple icons instead of buttons on back-office:
    ...
    if ($WidgetContainer->get_type() != 'main') {	// Allow to destroy sub-container when it is not included into the selected skin:
        $destroy_btn_title = ($WidgetContainer->main ? T_('Destroy container') : T_('Destroy sub-container'));
        $Table->global_icon($destroy_btn_title, 'delete', $destroy_container_url, '', 0, 0, [
            'onclick' => 'return confirm( \'' . TS_('Are you sure you want to destroy this container?') . '\' )',
        ]);
    }

    $widget_container_name = T_($WidgetContainer->get('name'));
    if ($mode == 'customizer') {	// Customizer mode:
        $Table->title = '<span class="container_name" data-wico_id="' . $widget_container_id . '">' . $widget_container_name . '</span>';
        if (! empty($WidgetContainer->ID)) {	// Link to edit current widget container:
        ...
        if (! empty($WidgetContainer->ID)) {
            ...
            if ($WidgetContainer->get_type() == 'page') {	// Display additional info for Page Container:
                $ItemCache = &get_ItemCache();
                if ($widget_Item = &$ItemCache->get_by_ID($WidgetContainer->get('item_ID'), false, false)) {	// If Item is found by ID:
                    $widget_container_name .= ' ' . sprintf( /* TRANS: widget container position On specific Item(Widget Page) */ T_('on %s'), $widget_Item->get_title([
                        'title_field' => 'short_title,title',
                        'link_type' => 'edit_view_url',
                    ]));
                } else {	// Not found Item by ID:
        ...
        if (get_default_widgets_by_container($WidgetContainer->get('code')) !== false) {	// Action icon to remove all widgets and replace with default widgets of the container from config:
            $Table->global_icon(
                T_('Reload container widgets'),
                'reload',
                ...
                0,
                [
                    'onclick' => 'return confirm( \'' . TS_('Do you want to reload the default widgets for this container?') . '\n' . TS_('THIS CANNOT BE UNDONE!') . '\n' . TS_('YOU MAY LOSE SOME CUSTOMIZATIONS!') . '\' )',
                ]
            );
        }

        $add_widget_link_params = [];
        if ($mode == 'customizer') {	// Set special url to add new widget on customizer mode:
        ...
        } else {	// Add id for link to initialize JS code of opening modal window only for not customizer mode,
    ...
    if ($params['table_layout'] == 'accordion_table') {	// Set ID for current widget container for proper work of accordion style:
        $params['group_item_id'] = 'container_' . $widget_container_id;
    }

    $Table->display_init(array_merge([
    ...
    if ($params['table_layout'] == 'accordion_table') {	// Start of accordion body of current item:
    ...
    if (! empty($widgets)) {
        ...
        foreach ($widgets as $widget) {
            ...
            if (! ($ComponentWidget = &$WidgetCache->get_by_ID($widget['wi_ID'], false, false))) {	// This is a broken widget, but we should display this in list in order to allow to delete it:
            ...
            // Checkbox:
            if ($mode != 'customizer') {	// Don't display on customizer mode:
            ...
            if ($disabled_plugin) {	// If widget's plugin is disabled:
                echo get_icon('warning', 'imgtag', [
                    'title' => T_('Inactive / Uninstalled plugin'),
                ]);
            } elseif ($wrong_widget) {	// If widget is wrong, e.g. widget has an old code:
                echo get_icon('warning', 'imgtag', [
                    'title' => T_('Wrong widget / Invalid code'),
                ]);
            } else {	// If this is a normal widget or widget's plugin is enabled:
                echo '<a href="#" onclick="return toggleWidget( \'wi_ID_' . $ComponentWidget->ID . '\' );">'
                        . get_icon(($enabled ? 'bullet_green' : 'bullet_empty_grey'), 'imgtag', [
                            'title' => ($enabled ? T_('The widget is enabled.') : T_('The widget is disabled.')),
                        ])
                    . '</a>';
            }
            echo '</span>';
            ...
            if ($mode != 'customizer') {	// Don't display on customizer mode:
                ...
                switch ($widget_cache_status) {
                    case 'disallowed':
                        echo get_icon('block_cache_disabled', 'imgtag', [
                            'title' => T_('This widget cannot be cached.'),
                    ...
                    case 'denied':
                        echo action_icon(
                            T_('This widget could be cached but the block cache is OFF. Click to enable.'),
                            'block_cache_denied',
                    ...
                    case 'enabled':
                        echo action_icon(
                            T_('Caching is enabled. Click to disable.'),
                            'block_cache_on',
                            regenerate_url('blog', 'action=cache_disable&amp;wi_ID=' . $ComponentWidget->ID . '&amp;' . url_crumb('widget')),
                            null,
                            null,
                            null,
                            [
                    ...
                    case 'disabled':
                        echo action_icon(
                            T_('Caching is disabled. Click to enable.'),
                            'block_cache_off',
                            regenerate_url('blog', 'action=cache_enable&amp;wi_ID=' . $ComponentWidget->ID . '&amp;' . url_crumb('widget')),
                            null,
                            null,
                            null,
                            [
            ...
            if ($mode != 'customizer') {	// Don't display on customizer mode:
                echo action_icon(
                    T_('Edit widget settings!'),
                    'edit',
                    regenerate_url('blog', 'action=edit&amp;wi_ID=' . $ComponentWidget->ID),
                    null,
                    null,
                    null,
                    [
                        'onclick' => 'return editWidget( \'wi_ID_' . $ComponentWidget->ID . '\' )',
                        'class' => '',
                    ]
                );
            }
            ...
            echo action_icon(
                T_('Duplicate'),
                'duplicate',
                regenerate_url('blog', 'action=duplicate&amp;wi_ID=' . $ComponentWidget->ID . '&amp;' . url_crumb('widget')),
                null,
                null,
                null,
                [
                    'onclick' => 'return duplicateWidget( \'wi_ID_' . $ComponentWidget->ID . '\', \'' . $mode . '\' )',
                    'class' => '',
                ]
            );
            ...
            // Remove:
            echo action_icon(
                T_('Remove this widget!'),
                'delete',
                regenerate_url('blog', 'action=delete&amp;wi_ID=' . $ComponentWidget->ID . '&amp;' . url_crumb('widget')),
                null,
                null,
                null,
                [
                    'onclick' => 'return deleteWidget( \'wi_ID_' . $ComponentWidget->ID . '\' )',
                    'class' => '',
                ]
            )
                . '</span>';
    ...
    if ($params['table_layout'] == 'accordion_table') {	// End of accordion body of current item:
        echo '</div>';
    }
 ...
 * @param array Params
 */
function display_containers($skin_type, $container_type, $params = [])
{
    global $Blog, $DB;
    ...
    switch ($container_type) {
        case 'main':
            ...
            foreach ($coll_containers as $container_code => $container_data) {
                ...
                if (! $WidgetContainer) {	// If widget container doesn't exist in DB but it is detected in skin file:
                    $WidgetContainer = new WidgetContainer();
                    $WidgetContainer->set('code', $container_code);
    ...
    foreach ($containers as $WidgetContainer) {	// Display each found container:
...
{
    if ($a[0]->get('order') == $b[0]->get('order')) {	// Sort by name if orders are equal:
        return strnatcmp($a[0]->get('name'), $b[0]->get('name'));
    } else {	// Sort by order if they are different:
 ...
 */
function get_widget_layout($params = [])
{
 ...
 * @return string
 */
function get_widget_layout_start($params = [])
{
 ...
 * @return string
 */
function get_widget_layout_end($cell_index = 0, $params = [])
{
    switch (get_widget_layout($params)) {
        case 'grid':
            // Grid / Table layout:
 ...
 * @return string
 */
function get_widget_layout_item_start($cell_index = 0, $is_selected = false, $disp_param_prefix = '', $params = [])
{
    switch (get_widget_layout($params)) {
        case 'grid':
            // Grid / Table layout:
        ...
        case 'rwd':
            ...
            if (isset($params['rwd_block_class'])) {	// Replace css class of RWD block with value from widget setting:
 ...
 * @return string
 */
function get_widget_layout_item_end($cell_index = 0, $is_selected = false, $disp_param_prefix = '', $params = [])
{
    switch (get_widget_layout($params)) {
        case 'grid':
            // Grid / Table layout:
