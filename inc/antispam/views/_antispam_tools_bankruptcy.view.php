...
$buttons = [];
if (! empty($blogs_list)) {
    $buttons[] = ['submit', 'actionArray[bankruptcy_delete]', sprintf(T_('Delete ALL comments with status %s from the selected blogs!'), $visibility_statuses[$comment_status]), 'RedButton',
