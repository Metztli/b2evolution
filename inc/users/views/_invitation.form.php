...
$Form->text_input('ivc_code', $edited_Invitation->code, 32, TB_('Invitation code'), TB_('Must be from 3 to 32 letters, digits or signs "-", "_".'), [
    'required' => true,
]);

$Form->begin_line(TB_('Expires'), 'ivc_expire_date', '', [
    'required' => true,
]);
...
$Form->select_input_object('ivc_grp_ID', $edited_Invitation->grp_ID, $GroupCache, TB_('Assign to Group'), [
    'allow_none' => true,
]);

$Form->text_input('ivc_level', $edited_Invitation->level, 32, TB_('Assign level'), '', [
    'maxlength' => 2,
]);

$Form->text_input('ivc_source', $edited_Invitation->source, 32, TB_('Assign source'), '', [
    'maxlength' => 30,
]);
