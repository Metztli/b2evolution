...
if ($action != 'view') { // We can edit the values:
    ...
    $Form->select_input_array('edited_user_results_page_size', $UserSettings->get('results_per_page', $edited_User->ID), $results_per_page_options, TB_('Results per page'), TB_('Number of rows displayed in results tables.'), [
...
if ($action != 'view') { // Edit buttons
    $Form->buttons([
        ['', 'actionArray[update]', TB_('Save Changes!'), 'SaveButton'],
