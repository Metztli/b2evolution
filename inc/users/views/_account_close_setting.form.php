...
$Form->checkbox_input('account_close_enabled', $Settings->get('account_close_enabled'), TB_('Allow closing'), [
    'note' => TB_('check to allow users to close their account themselves.'),
]);
