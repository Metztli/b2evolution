...
$Form->select_input_array('msgform_avatar_size', $edited_Blog->get_setting('msgform_avatar_size'), get_available_thumb_sizes(), TB_('Avatar') . ':', '', [
    'force_keys_as_values' => true,
]);
$Form->end_line();
$Form->radio('msgform_user_name', $edited_Blog->get_setting('msgform_user_name'), [
    ['fullname', TB_('First + Last Name')],
    ['nickname', TB_('Nickname')],
    ['none',     TB_('None')],
...
$Form->select_input('new_user_field', 0, 'callback_options_user_new_fields', TB_('Additional fields'), [
...
$msgform_message_label_params = [];
if (! $edited_Blog->get_setting('msgform_display_message')) {	// Disable field "Label of message field" if message is not allowed:
