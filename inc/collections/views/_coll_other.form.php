...
$Form->radio(
    'archive_mode',
    $edited_Blog->get_setting('archive_mode'),
    [['monthly', TB_('monthly')],
        ['weekly', TB_('weekly')],
        ['daily', TB_('daily')],
        ['postbypost', TB_('post by post')],
    ],
    TB_('Archive grouping'),
    false,
    TB_('How do you want to browse the post archives? May also apply to permalinks.')
);
...
$Form->radio(
    'archives_sort_order',
    $edited_Blog->get_setting('archives_sort_order'),
    [['date', TB_('date')],
        ['title', TB_('title')],
    ],
    TB_('Archive sorting'),
    false,
    TB_('How to sort your archives? (only in post by post mode)')
);
...
if (isset($GLOBALS['files_Module'])) {
    ...
    $Form->select_input_array('image_size_messaging', $edited_Blog->get_setting('image_size_messaging'), get_available_thumb_sizes(), TB_('Profile picture size'), '', [
