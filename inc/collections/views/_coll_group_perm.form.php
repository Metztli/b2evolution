...
$Results->global_icon(TB_('Export CSV'), '', $admin_url . '?ctrl=coll_settings&amp;action=export_groupperms&amp;blog=' . $edited_Blog->ID . (empty($keywords) ? '' : '&amp;keywords=' . urlencode($keywords)), TB_('Export CSV'), 3, 3, [
...
if (! empty($Results->rows)) {
    ...
    $form_buttons[] = ['submit', 'actionArray[update]', TB_('Save Changes!'), 'SaveButton'];
}
