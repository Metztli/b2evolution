...
if (empty($_GET['blog'])) { // Use dashboard for selected blog only from GET request
    $blog = 0;
...
if (check_user_perm('options', 'edit')) { // We have some serious admin privilege:
    /**
    ...
    if (b2evonet_get_updates() !== null) {	// Updates are allowed, display them:
