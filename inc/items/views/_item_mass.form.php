...
$Form->submit(['actionArray[' . $next_action . ']', /* TRANS: This is the value of an input submit button */ TB_('Create posts'), 'SaveButton']);
...
$Form->begin_fieldset(TB_('Visibility / Sharing'), [
...
if ($edited_Item->allow_comment_statuses()) {
    $Form->begin_fieldset(TB_('Comments'), [
