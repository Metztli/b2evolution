...
$Form->text_input('days', 10, 3, TB_('Days of stats to generate'), '', [
    'required' => true,
]);
$Form->text_input('min_interval', 0, 5, TB_('Minimal interval between 2 consecutive hits (sec)'), '', [
    'required' => true,
]);
$Form->text_input('max_interval', 5000, 5, TB_('Maximal interval between 2 consecutive hits (sec)'), '', [
    'required' => true,
]);
...
$Form->end_form([['submit', 'submit', TB_('Generate'), 'SaveButton']]);
