...
if ($itxml_import_data['errors'] === false) {	// Import the data and display a report on the screen:
...
$Form->buttons([
    [
        'button',
        'button',
        TB_('Go to Item Types') . ' >>',
        'SaveButton',
        'onclick' => 'location.href=\'' . $admin_url . '?ctrl=itemtypes&amp;tab=settings&amp;tab3=types\'',
    ],
]);
