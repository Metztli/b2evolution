...
if (! empty($import_files)) {
    ...
    foreach ($BlogCache->cache as $it_Blog) {
        $coll_options[] = ['it_blog_IDs[]', $it_Blog->ID, $it_Blog->get_extended_name(), (is_array($last_import_coll_IDs) && in_array($it_Blog->ID, $last_import_coll_IDs))];
    }
    $Form->checklist($coll_options, 'it_blog_IDs', TB_('Enable for collections'), false, false, [
