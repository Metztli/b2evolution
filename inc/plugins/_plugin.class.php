...
class Plugin
{
     ...
     * @var boolean
     */
    public $_trans_loaded_global = false;
     ...
     * @var string
     */
    public $widget_icon = 'puzzle-piece';
    ...
    public function PluginInit(&$params)
    {
        ...
        if (is_null($this->short_desc)) { // may have been set in plugin's constructor (which is deprecated since 1.9)
            $this->short_desc = T_('No desc available');
        }
        if (is_null($this->long_desc)) { // may have been set in plugin's constructor (which is deprecated since 1.9)
            $this->long_desc = T_('No description available');
        }

        if (method_exists($this, 'AppendPluginRegister') && $params['is_installed']) { // Wrapper for deprecated AppendPluginRegister method (deprecated since 1.9)
            $this->debug_log('Plugin has deprecated AppendPluginRegister method. Use PluginInit instead.', ['deprecated']);
     ...
     * @return string
     */
    public function get_param_prefix()
    {
    ...
    public function load_template()
    {
        ...
        if (is_admin_page()) { // Get plugin template from backoffice skin
            if (is_logged_in()) {
        ...
        } else { // Get plugin template from frontoffice skin
        ...
        if (empty($skin_template)) { // Use default template params when they are not set by skin
            $this->template = $params;
        } else { // Merge default params with current skin params
            $this->template = array_merge($params, $skin_template);
        }

        if (! empty($this->template['toolbar_title_after'])) { // Add toolbar info icon after the title
            $toolbar_params = [
                'tooltip_field' => 'name',
     ...
     */
    public function get_template($param_name, $replaces = null)
    {
        if (is_null($this->template)) { // Load template only first time
            $this->load_template();
        }

        if (! isset($this->template[$param_name])) { // Return empty string if no defined param
            return '';
        }
     ...
     * @return array See {@link Plugin::GetDefaultSettings()}.
     */
    public function GetDefaultGroupSettings(&$params)
    {
        return [];
    }
        ...
        switch ($this->group) {
            ...
            case 'editor':
                ...
                if ($default_post_using != 'disabled') {
                    $default_settings['coll_use_for_posts'] = [
                ...
                if ($default_comment_using != 'disabled') {
                    $default_settings['coll_use_for_comments'] = [
     ...
     * @return array See {@link Plugin::GetDefaultSettings()}.
     */
    public function get_msg_setting_definitions(&$params)
    {
     ...
     * @return array See {@link Plugin::GetDefaultSettings()}.
     */
    public function get_shared_setting_definitions(&$params)
    {
        if ($this->group != 'rendering') {
            return $this->get_custom_setting_definitions($params);
        }
    ...
    {
        if (! is_array($params)) {	// Must be array:
            $params = [];
        }
        ...
        return array_merge($ComponentWidget->get_param_definitions([]), $params);
    }
     ...
     */
    public function get_widget_cache_keys($widget_ID = 0)
    {
    ...
    {
        return []; // no dependencies by default, of course
    }
     ...
     *               gets executed.
     */
    public function GetCronJobs(&$params)
    {
        return [];
    }
     ...
     */
    public function ExecCronJob(&$params)
    {
    }
     ...
     */
    public function AdminAfterEvobarInit()
    {
    }
     ...
     */
    public function AdminAfterMenuInit()
    {
        // Example:
     ...
     * @return boolean did we do something?
     */
    public function AdminAfterPageFooter(&$params)
    {
        return false;		// Do nothing by default.
    }
     ...
     */
    public function AdminToolPayload()
    {
        return false;		// Do nothing by default.
    }
     ...
     * Use {@link msg()} to add messages for the user.
     */
    public function AdminTabAction()
    {
    }
     ...
     * @return boolean did we display something?
     */
    public function AdminTabPayload()
    {
        return false;		// Do nothing by default.
    }
     ...
     */
    public function AdminBeginPayload()
    {
    }
     ...
     * @return boolean did we display something?
     */
    public function WidgetBeginSettingsForm(&$params)
    {
        return false; // Do nothing by default.
    }
     ...
     * @return boolean did we display something?
     */
    public function WidgetEndSettingsForm(&$params)
    {
        return false; // Do nothing by default.
    }
     ...
     */
    public function BeforeBlogDisplay(&$params)
    {
    }
     ...
     */
    public function BeforeBlockableAction()
    {
    }
     ...
     */
    public function InitMainList(&$params)
    {
     ...
     * @param array Associative array of parameters
     */
    public function SkinEndHtmlHead(&$params)
    {
    }
     ...
     * @param array Associative array of parameters
     */
    public function SkinBeginHtmlBody(&$params)
    {
    }
     ...
     * @param array Associative array of parameters
     */
    public function SkinEndHtmlBody(&$params)
    {
    }
     ...
     * @param array Associative array of parameters
     */
    public function BeforeSkinWrapper(&$params)
    {
    }
     ...
     */
    public function SkinTag(&$params)
    {
    }
     ...
     * @return array
     */
    public function GetProvidedSkins()
    {
        return [];
    }
     ...
     */
    public function DisplaySkin(&$params)
    {
    }
     ...
     */
    public function BeforeUninstall(&$params)
    {
        return true;
    }
     ...
     */
    public function BeforeUninstallPayload(&$params)
    {
    }
     ...
     */
    public function PluginVersionChanged(&$params)
    {
        return true;
    }
     ...
     */
    public function AfterCollectionInsert(&$params)
    {
    }
     ...
     *   - 'Blog': the related Blog (by reference)
     */
    public function AfterCollectionUpdate(&$params)
    {
    }
     ...
     *   - 'Blog': the related Blog (by reference)
     */
    public function AfterCollectionDelete(&$params)
    {
    }
     ...
     * @retun: array
     */
    public function GetCollectionKinds(&$params)
    {
        return [];
    }
     ...
     */
    public function InitCollectionKinds(&$params)
    {
    }
     ...
     * @return boolean Have we changed something?
     */
    public function PrepareForRenderItemAttachment(&$params)
    {
        return false; // Do nothing by default.
    }
     ...
     * @return boolean Have we changed something?
     */
    public function RenderItemAttachment(&$params)
    {
        return false; // Do nothing by default.
    }
     ...
     * @return boolean Have we changed something?
     */
    public function RenderItemAsXml(&$params)
    {
        return false;		// Do nothing by default.
    }
     ...
     * @return boolean Have we changed something?
     */
    public function RenderItemAsText(&$params)
    {
        return false;		// Do nothing by default.
    }
     ...
     * @return boolean Have we changed something?
     */
    public function DisplayItemAsText(&$params)
    {
        return false;		// Do nothing by default.
    }
     ...
     */
    public function PrependItemUpdateTransact(&$params)
    {
    }
     ...
     */
    public function AfterItemUpdate(&$params)
    {
    }
     ...
     *   - 'Item': the related Item (by reference)
     */
    public function PrependItemInsertTransact(&$params)
    {
    }
     ...
     *                  before they got applied (since 1.9)
     */
    public function AfterItemInsert(&$params)
    {
    }
     ...
     *   - 'Item': the related Item (by reference)
     */
    public function AfterItemDelete(&$params)
    {
    }
     ...
     *   - 'Item': the related Item (by reference)
     */
    public function AppendItemPreviewTransact(&$params)
    {
    }
     ...
     *   - 'Item': the related Item (by reference)
     */
    public function ItemLoadFromRequest(&$params)
    {
    }
     ...
     * @return boolean did we display something?
     */
    public function AdminDisplayItemFormFieldset(&$params)
    {
        return false;		// Do nothing by default.
    }
     ...
     * @return boolean did we display something?
     */
    public function DisplayItemFormFieldset(&$params)
    {
        return false;		// Do nothing by default.
    }
     ...
     */
    public function AdminBeforeItemEditDelete(&$params)
    {
    }
     ...
     *              'Item': the Item which gets created (by reference)
     */
    public function AdminBeforeItemEditCreate(&$params)
    {
    }
     ...
     */
    public function AdminBeforeItemEditUpdate(&$params)
    {
    }
     ...
     */
    public function ItemCanComment(&$params)
    {
    }
     ...
     */
    public function DisplayTrackbackAddr(&$params)
    {
    }
     ...
     */
    public function ItemApplyAsRenderer(&$params)
    {
    }
     ...
     * @return boolean did we display something?
     */
    public function AdminDisplayCommentFormFieldset(&$params)
    {
        return false;		// Do nothing by default.
    }
     ...
     */
    public function DisplayCommentFormFieldset(&$params)
    {
    }
     ...
     *   - 'Item': the Item for which the comment is meant
     */
    public function DisplayCommentFormButton(&$params)
    {
    }
     ...
     *     (by reference).
     */
    public function CommentFormSent(&$params)
    {
    }
     ...
     */
    public function BeforeCommentFormInsert(&$params)
    {
    }
     ...
     *   - 'original_comment': this is the unstripped and unformated posted comment
     */
    public function AfterCommentFormInsert(&$params)
    {
    }
     ...
     */
    public function GetSpamKarmaForComment(&$params)
    {
        return;
    }
     ...
     */
    public function PrependCommentUpdateTransact(&$params)
    {
    }
     ...
     *                  before they got applied (since 1.9)
     */
    public function AfterCommentUpdate(&$params)
    {
    }
     ...
     *   - 'Comment': the related Comment (by reference)
     */
    public function PrependCommentInsertTransact(&$params)
    {
    }
     ...
     *                  before they got applied (since 1.9)
     */
    public function AfterCommentInsert(&$params)
    {
    }
     ...
     *   - 'Comment': the related Comment (by reference)
     */
    public function AfterCommentDelete(&$params)
    {
    }
     ...
     */
    public function BeforeTrackbackInsert(&$params)
    {
    }
     ...
     *        - "title"/"excerpt" => "comment"
     */
    public function AfterTrackbackInsert(&$params)
    {
    }
     ...
     */
    public function FilterCommentAuthor(&$params)
    {
    }
     ...
     *   - 'Comment': the {@link Comment} object
     */
    public function FilterCommentAuthorUrl(&$params)
    {
    }
     ...
     *   - 'Comment': the {@link Comment} object
     */
    public function FilterCommentContent(&$params)
    {
        if ($this->group == 'rendering') { // All plugin from 'rendering' group has a 'coll_apply_comment_rendering' setting
            $Comment = &$params['Comment'];
            $comment_Item = &$Comment->get_Item();
            $comment_Blog = &$comment_Item->get_Blog();
            if (in_array($this->code, $Comment->get_renderers_validated())) { // Always allow rendering for comment
     ...
     */
    public function DisplayMessageFormFieldset(&$params)
    {
    }
     ...
     *   - 'comment_ID': ID of the comment where the user clicked the msgform icon (if any)
     */
    public function DisplayMessageFormButton(&$params)
    {
    }
     ...
     */
    public function MessageThreadFormSent(&$params)
    {
    }
     ...
     */
    public function MessageFormSent(&$params)
    {
    }
     ...
     */
    public function MessageFormSentCleanup(&$params)
    {
    }
     ...
     */
    public function FilterMsgContent(&$params)
    {
        if ($this->group == 'rendering') { // All plugin from 'rendering' group has a 'msg_apply_rendering' setting
            $Message = &$params['Message'];
            if (in_array($this->code, $Message->get_renderers_validated())) { // Always allow rendering for message
                $render_params = array_merge([
                    'data' => &$Message->text,
                ], $params);
     ...
     */
    public function PrependMessageInsertTransact(&$params)
    {
    }
     ...
     * @return boolean Have we changed something?
     */
    public function RenderMessageAsHtml(&$params)
    {
     ...
     * @return boolean Have we changed something?
     */
    public function PrepareForRenderMessageAttachment(&$params)
    {
        return false; // Do nothing by default.
    }
     ...
     * @return boolean Have we changed something?
     */
    public function RenderMessageAttachment(&$params)
    {
        // Use this render by default temporarily:
     ...
     *   - 'content': the message text (by reference)
     */
    public function EmailFormSent(&$params)
    {
    }
     ...
     */
    public function FilterEmailContent(&$params)
    {
        if ($this->group == 'rendering') {	// All plugin from 'rendering' group has a 'email_apply_rendering' setting
            $EmailCampaign = &$params['EmailCampaign'];
            if (in_array($this->code, $EmailCampaign->get_renderers_validated())) { // Always allow rendering for $EmailCampaign
                $render_params = array_merge([
                    'data' => &$EmailCampaign->email_text,
                ], $params);
     ...
     */
    public function PrependEmailInsertTransact(&$params)
    {
    }
     ...
     *   - 'EmailCampaign': the related EmailCampaign (by reference)
     */
    public function PrependEmailUpdateTransact(&$params)
    {
    }
     ...
     * @return boolean Have we changed something?
     */
    public function RenderEmailAsHtml(&$params)
    {
        // Use this render by default temporarily
        return $this->RenderItemAsHtml($params);
    }
     ...
     * @return boolean Have we changed something?
     */
    public function PrepareForRenderEmailAttachment(&$params)
    {
        return false; // Do nothing by default.
    }
     ...
     * @return boolean Have we changed something?
     */
    public function RenderEmailAttachment(&$params)
    {
        // Use this render by default temporarily
        return $this->RenderItemAttachment($params);
    }
     ...
     */
    public function CacheObjects(&$params)
    {
    }
     ...
     */
    public function CachePageContent(&$params)
    {
    }
     ...
     * @return boolean
     */
    public function CacheIsCollectingContent()
    {
    }
     ...
     */
    public function BeforeThumbCreate(&$params)
    {
    }
     ...
     */
    public function PluginSettingsValidateSet(&$params)
    {
    }
     ...
     * something.
     */
    public function PluginSettingsEditAction()
    {
    }
     ...
     */
    public function PluginSettingsEditDisplayAfter(&$params)
    {
    }
     ...
     *                     and/or a message added to the settings field.
     */
    public function PluginUserSettingsValidateSet(&$params)
    {
    }
     ...
     * @return false|null Return false to prevent the settings from being updated to DB.
     */
    public function PluginUserSettingsUpdateAction(&$params)
    {
    }
     ...
     */
    public function PluginUserSettingsEditAction(&$params)
    {
    }
     ...
     */
    public function PluginUserSettingsEditDisplayAfter(&$params)
    {
    }
     ...
     *                     and/or a message added to the settings field.
     */
    public function PluginGroupSettingsValidateSet(&$params)
    {
    }
     ...
     */
    public function PluginCollSettingsUpdateAction()
    {
    }
     ...
     * Use this to add notes/errors through {@link Plugin::msg()} or to process saved settings.
     */
    public function PluginMsgSettingsUpdateAction()
    {
    }
     ...
     * Use this to add notes/errors through {@link Plugin::msg()} or to process saved settings.
     */
    public function PluginEmailSettingsUpdateAction()
    {
    }
     ...
     * Use this to add notes/errors through {@link Plugin::msg()} or to process saved settings.
     */
    public function PluginSharedSettingsUpdateAction()
    {
    }
     ...
     */
    public function AfterLoginAnonymousUser(&$params)
    {
    }
     ...
     * there is a $login_error global variable
     */
    public function AfterLoginRegisteredUser(&$params)
    {
    }
     ...
     */
    public function AppendUserRegistrTransact(&$params)
    {
        return true;
    }
     ...
     *   - 'User': the {@link User user object} (as reference).
     */
    public function AfterUserRegistration(&$params)
    {
    }
     ...
     */
    public function DisplayRegisterFormBefore(&$params)
    {
    }
     ...
     *   - 'inskin': boolean true if the form is displayed in skin
     */
    public function DisplayRegisterFormFieldset(&$params)
    {
    }
     ...
     */
    public function RegisterFormSent(&$params)
    {
    }
     ...
     *   - 'Form': the comment form generating object (by reference)
     */
    public function DisplayLoginFormFieldset(&$params)
    {
    }
     ...
     */
    public function LoginAttempt(&$params)
    {
    }
     ...
     */
    public function LoginAttemptNeedsRawPassword()
    {
        return false;
    }
     ...
     *   - 'Form': the comment form generating object (by reference)
     */
    public function DisplayValidateAccountFormFieldset(&$params)
    {
    }
     ...
     * of type "error".
     */
    public function ValidateAccountFormSent(&$params)
    {
    }
     ...
     */
    public function DisplayProfileFormFieldset(&$params)
    {
        if ($params['edit_layout'] == 'public') { // Do nothing in public mode
            return false;
        }
     ...
     */
    public function ProfileFormSent(&$params)
    {
    }
     ...
     */
    public function AlternateAuthentication(&$params)
    {
    }
     ...
     */
    public function AfterUserUpdate(&$params)
    {
    }
     ...
     *   - 'User': the related User (by reference)
     */
    public function AfterUserInsert(&$params)
    {
    }
     ...
     *   - 'User': the related User (by reference)
     */
    public function AfterUserDelete(&$params)
    {
    }
     ...
     * @return boolean did we do something?
     */
    public function AdminAfterUsersList(&$params)
    {
        return false;		// Do nothing by default.
    }
     ...
     */
    public function RequestCaptcha(&$params)
    {
    }
     ...
     */
    public function AfterObjectInsert(&$params)
    {
    }
     ...
     *   - 'type': class name of deleted Object (Chapter, File, Blog, Link, Comment, Slug etc.) (by reference)
     */
    public function AfterObjectUpdate(&$params)
    {
    }
     ...
     *   - 'type': class name of deleted Object (Chapter, File, Blog, Link, Comment, Slug etc.) (by reference)
     */
    public function AfterObjectDelete(&$params)
    {
    }
    // }}}
     ...
     * @return boolean Have we changed something?
     */
    public function FilterIpAddress(&$params)
    {
        return false;		// Do nothing by default.
    }
     ...
     */
    public function BeforeSessionsDelete(&$params)
    {
        return [];
    }
     ...
     */
    public function AppendHitLog(&$params)
    {
        // Do nothing by default:
        return false;
    }
     ...
     */
    public function AfterFileUpload(&$params)
    {
     ...
     */
    public function GetAuthLinksForSocialNetworks(&$params)
    {
        return false;
    }
     ...
     * @return string
     */
    public function get_class_id($append = '')
    {
    ...
    public function T_($string, $req_locale = '')
    {
        ...
        if (($return = T_($string, $req_locale, [
            'ext_transarray' => &$this->_trans,
            'alt_basedir' => $plugins_path . $this->classname,
        ])) == $string) {	// Fallback to global translation file:
     ...
     */
    public function TS_($string, $req_locale = '')
    {
     ...
     * @return string
     */
    public function get_plugin_url($dummy = false)
    {
        global $ReqHost, $plugins_url, $plugins_path, $Collection, $Blog;

        if (empty($this->_plugin_url)) {	// Initialize plugin URL only first time request:
            // Get sub-path below $plugins_path, if any:
            $sub_path = preg_replace(':^' . preg_quote($plugins_path, ':') . ':', '', dirname($this->classfile_path) . '/');

            if (is_admin_page() || empty($Blog)) {	// Get plugin url for nack-office and when collection is not viewed now:
                $r = $plugins_url . $sub_path;
            } else {	// Get plugin url depending on collection setting:
     ...
     */
    public function debug_log($msg, $add_cats = [])
    {
        global $Debuglog;
        ...
        if (! isset($this->ID, $this->classname)) { // plugin not yet instantiated. This happens, if the (deprecated) constructor of a plugin gets used.
     ...
     */
    public function get_htsrv_url($method, $params = [], $glue = '&amp;', $abs = false)
    {
        global $ReqHost;

        $base = substr($ReqHost, 0, 6) == 'https:' ? get_htsrv_url(true) : get_htsrv_url();

        if (! $abs && strpos($base, $ReqHost) === 0) { // cut off $ReqHost if the resulting URL starts with it:
     ...
     */
    public function msg($msg, $category = 'note')
    {
        global $Messages;
     ...
     */
    public function register_menu_entry($text, $path = ['options', 'misc'], $menu_entry_props = [])
    {
        global $AdminUI;
        ...
        $AdminUI->add_menu_entries($path, [
            'plug_ID_' . $this->ID => $menu_entry_props,
        ]);
    }
     ...
     */
    public function get_tools_tab_url()
    {
        global $admin_url;
     ...
     * @return boolean
     */
    public function are_events_available($events, $by_one_plugin = false)
    {
        global $Plugins;
    ...
    public function set_status($status)
    {
        ...
        if (! in_array($status, ['enabled', 'disabled', 'needs_config'])) {
            return false;
        }
     ...
     * @return string
     */
    public function get_sql_table($name)
    {
        global $tableprefix;
     ...
     */
    public function session_set($name, $value, $timeout, $save_immediately = false)
    {
        global $Session;
     ...
     */
    public function get_help_link($target = '', $icon = 'help', $use_tooltip = true, $params = [])
    {
        ...
        $link_attribs = [
            'target' => '_blank',
            'id' => 'anchor_help_plugin_' . $this->ID . '_' . $target_counter++,
        ];
        $params = array_merge([
        ...
        if (empty($target) || in_array($target, ['$help_url', '$apply_rendering', '$widget_url'])) {
            if ($target == '$apply_rendering') { // Url to info about plugin apply rendering options
                $url = get_manual_url('plugin-apply-rendering');
            } else { // Url to current plugin info
                $url = $this->get_help_url($target);
            }
            $title = T_('Homepage of the plugin');
            if ($use_tooltip) { // Add these data only for tooltip
        ...
        } elseif ($target == '$readme') { // README
            // fplanque> note: we do NOT want the plugin to waste time searching for files on disk -- this has been replaced with bubbletips.
            return '';
        } elseif (substr($target, 0, 1) == '#') { // anchor
            $url = $this->get_help_url() . $target;
        } elseif (preg_match('~^https?://~', $target)) { // absolute URL (strict match to allow other formats later if needed)
            $url = $target;
        } else {
     ...
     * @return string
     */
    public function get_help_url($target = '')
    {
        if ($target == '$widget_url') { // Get url for widget plugin manual
        ...
        } else { // Get standard help url of the plugin
     ...
     */
    public function get_README_link()
    {
        // fplanque> note: we do NOT want the plugin to waste time searching for files on disk -- this has been replaced with bubbletips.
        return '';
    }
     ...
     * @return false|string
     */
    public function get_help_file()
    {
        global $default_locale, $plugins_path;

        if (! check_user_perm('options', 'view')) { // README gets displayed through plugins controller, which requires these perms
        ...
        if (! file_exists($help_file)) { // Fallback: README.html
     ...
     * @return false|string
     */
    public function get_edit_settings_link()
    {
     ...
     * @return false|string
     */
    public function get_edit_settings_url()
    {
        global $admin_url;
     ...
     */
    public function init_widget_params($params, $default_params = [])
    {
        if (isset($params['wi_ID']) &&
            (! isset($this->current_widget_ID) || $this->current_widget_ID != $params['wi_ID'])) {	// Reset widget params on switch plugin to display next widget:
        ...
        if (! isset($this->widget_params)) {	// Don't initialize params twice:
     ...
     * @return mixed|null
     */
    public function get_widget_setting($name = null, $params = null)
    {
        if ($params === null && isset($this->widget_params)) {	// Use the initialized widget params by default:
     ...
     */
    public function display_widget_title($widget_title = null)
    {
        if ($widget_title === null) {	// Use title from widget param:
            $widget_title = $this->get_widget_setting('title');
        }

        if (! empty($widget_title)) {	// We want to display a title for the widget block:
     ...
     * @param string Message
     */
    public function display_widget_debug_message($message = null, $params = [])
    {
        ...
        if (isset($this->widget_params['debug_mode']) && $this->widget_params['debug_mode'] == 'designer') {	// Display message on designer mode:
            echo $this->widget_params['block_start'];
            if (! empty($this->widget_params['title'])) {	// Display title:
                echo $this->widget_params['block_title_start'];
     ...
     */
    public function &get_Blog_from_params($params)
    {
        $setting_Blog = false;

        if ($setting_Item = &$this->get_Item_from_params($params)) {	// Get Collection from given Item or Comment:
            $setting_Blog = &$setting_Item->get_Blog();
        } elseif (! empty($params['Blog'])) {	// Get Collection from params:
     ...
     */
    public function &get_Item_from_params($params)
    {
        $setting_Item = false;

        if (! empty($params['Item']) && $params['Item'] instanceof Item) {	// Use the passed Item:
            $setting_Item = &$params['Item'];
        } elseif (! empty($params['Comment']) && $params['Comment'] instanceof Comment) {	// Get Item from given Comment:
            $Comment = &$params['Comment'];
     ...
     */
    public function get_coll_setting($parname, &$Blog, $allow_null_blog = false, $group = null)
    {
        if (empty($Blog)) { // Blog is not defined
            if (! $allow_null_blog) { // Empty blog is not allowed, Exit here
                return null;
            } else { // We can get the coll default settings of this plugin
                $blog_type = 'std';
            }
        } else { // Get setting value from Blog
            // Name of the setting in the blog settings:
            $blog_setting_name = 'plugin' . $this->ID . '_' . $parname;

            if (strpos($blog_setting_name, '[') !== false) {	// Get value for array setting like "sample_sets[0][group_name_param_name]":
            ...
            } else {	// Get normal(not array) setting value:
                $value = $Blog->get_setting($blog_setting_name);
            }

            if (! is_null($value)) { // We have a value for this param:
                return $value;
            }
     ...
     */
    public function get_default_setting($parname, $params, $group = null)
    {
        if ($group === null) {	// Get default value from sinple field:
            if (isset($params[$parname]['type']) && $params[$parname]['type'] == 'checklist' &&
                ! empty($params[$parname]['options']) && is_array($params[$parname]['options'])) {	// Get default values for checklist:
                $param_defaults = [];
                foreach ($params[$parname]['options'] as $param_option) {
                    $param_defaults[$param_option[0]] = $param_option[2];
                }
                return $param_defaults;
            } elseif (isset($params[$parname]['defaultvalue'])) {	// We have a default value:
                return $params[$parname]['defaultvalue'];
            }
        } else {	// Get default value from input group field:
            $parname = substr($parname, strlen($group));
            if (isset($params[$group]['inputs'][$parname]['defaultvalue'])) {	// We have a default value:
     ...
     * @return string Setting value
     */
    public function get_coll_default_setting($parname, $blog_type = 'std', $group = null)
    {
        $tmp_params = [
            'for_editing' => true,
            'blog_type' => $blog_type,
     ...
     */
    public function set_coll_setting($parname, $parvalue, $blog = null)
    {
        /**
         * @var Blog
         */
     ...
     */
    public function delete_coll_setting($parname, $blog = null)
    {
        /**
         * @var Blog
         */
     ...
     * @return string Setting value
     */
    public function get_setting($parname, $group = null)
    {
        ...
        if ($value !== null) { // We have a value for this param:
            return $value;
        }
     ...
     * @return string Setting value
     */
    public function get_msg_setting($parname, $group = null)
    {
        if (empty($this->Settings)) {
            global $Plugins;
            $Plugins->instantiate_Settings($this, 'Settings');
     ...
     * @return string Setting value
     */
    public function get_email_setting($parname, $group = null)
    {
        if (empty($this->Settings)) {
            global $Plugins;
            $Plugins->instantiate_Settings($this, 'Settings');
        ...
        if ($parname == 'email_apply_rendering' && empty($params)) {	// Empty params mean this plugin cannot be used for Email Campaign at all:
            return 'never';
        }
     ...
     * @return string Setting value
     */
    public function get_shared_setting($parname, $group = null)
    {
        if (empty($this->Settings)) {
            global $Plugins;
            $Plugins->instantiate_Settings($this, 'Settings');
        ...
        if ($group === null) {	// Get default value from sinple field:
            if (isset($params[$parname]['defaultvalue'])) {	// We have a default value:
                return $params[$parname]['defaultvalue'];
            }
        } else {	// Get default value from input group field:
            $parname = substr($parname, strlen($group));
     ...
     * @return boolean
     */
    public function is_shared_widget($params)
    {
        if (! is_array($params) || ! isset($params['Widget'])) {	// This is a not request for widget rendering:
            return false;
        }

        if (($plugin_WidgetContainer = &$params['Widget']->get_WidgetContainer()) &&
            ($plugin_WidgetContainer->get('coll_ID') == 0)) {	// This is a request to render widget from shared container:
            return true;
        }
     ...
     */
    public function is_renderer_enabled($rendering_setting_value, $renderers)
    {
        switch ($rendering_setting_value) {
            ...
            case 'opt-in':
            case 'lazy':
                if (is_array($renderers) && in_array($this->code, $renderers)) { // Option is enabled
                    return true;
                }
                // Option is disabled
                return false;
     ...
     */
    public function is_plugin_action($action)
    {
     ...
     */
    public function GetUserFromCountrySuffix(&$params)
    {
        return '';
    }
     ...
     *   'Results' - Object
     */
    public function GetAdditionalColumnsTable(&$params)
    {
    }
     ...
     */
    public function RenderInlineTags(&$params)
    {
    }
     ...
     *   value - Tab title
     */
    public function GetImageInlineTags(&$params)
    {
        return [];
    }
     ...
     */
    public function InitImageInlineTagForm(&$params)
    {
    }
     ...
     */
    public function DisplayImageInlineTagForm(&$params)
    {
        return false;
    }
     ...
     */
    public function GetInsertImageInlineTagJavaScript(&$params)
    {
    }
     ...
     */
    public function require_css($css_file, $output = false, $position = 'headlines', $async = false)
    {
     ...
     * @param string Position where the CSS files will be inserted, either 'headlines' (inside <head>) or 'footerlines' (before </body>)
     */
    public function require_css_async($css_file, $output = false, $position = 'headlines')
    {
        global $app_version_long;
     ...
     */
    public function require_js($js_file, $output = false, $async_defer = false, $position = 'headlines')
    {
        global $app_version_long;
     ...
     * @param string Position where the JS file will be inserted, either 'headlines' (inside <head>) or 'footerlines' (before </body>)
     */
    public function require_js_async($js_file, $output = false, $position = 'headlines')
    {
     ...
     * @param string Position where the JS file will be inserted, either 'headlines' (inside <head>) or 'footerlines' (before </body>)
     */
    public function require_js_defer($js_file, $output = false, $position = 'headlines')
    {
     ...
     * @return boolean
     */
    public function get_checklist_setting($group_name, $setting_name, $setting_type = 'default', $object = null)
    {
        switch ($setting_type) {
            case 'coll':
     ...
     */
    public function ImporterConstruct(&$params)
    {
    }
     ...
     */
    public function ImporterSetItemField(&$params)
    {
    }
     ...
     */
    public function ImporterAfterItemImport(&$params)
    {
    }
     ...
     */
    public function ImporterAfterItemsDelete(&$params)
    {
    }
}
