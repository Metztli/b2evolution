...
$Form->text_input('dom_name', $edited_Domain->get('name'), 50, TB_('Name'), '', [
    'maxlength' => 250,
    'required' => true,
]);

$Form->select_input_array('dom_type', $edited_Domain->get('type'), stats_dom_type_titles(), TB_('Referrer type'), '', [
    'force_keys_as_values' => true,
    'required' => true,
]);

$Form->text_input('dom_source_tag', $edited_Domain->get('source_tag'), 32, TB_('Source Tag'), '', [
    'maxlength' => 32,
]);

$Form->select_input_array('dom_status', $edited_Domain->get('status'), stats_dom_status_titles(), TB_('Spam status'), '', [
    'force_keys_as_values' => true,
    'background_color' => stats_dom_status_colors(),
    'required' => true,
]);

$Form->text_input('dom_comment', $edited_Domain->get('comment'), 255, TB_('Comment'), '', [
    'maxlength' => 255,
]);
