...
if (($Plugin = &$Plugins->get_by_code('evo_GeoIP')) !== false) { // Country by GeoIP plugin
...
} else { // No country, Display help icon
    $Results->cols[] = [
        'th' => T_('Country'),
...
$Results->cols[] = [
    ...
    'th_class' => 'shrinkwrap',
    'extra' => [
        'style' => 'background-color: %hit_iprange_status_color( "#hit_remote_addr#" )%;',
