...
$diagram_columns = [
    ...
    'standard_robot' => [
        'title' => T_('Standard/Robots'),
        'link_data' => ['standard', 'robot'],
    ],
    'standard_browser' => [
        'title' => T_('Standard/Browsers'),
        'link_data' => ['standard', 'browser'],
    ],
    'ajax' => [
        'title' => T_('Ajax'),
        'link_data' => ['ajax',     ''],
...
if (count($res_hits)) {
    ...
    foreach ($res_hits as $row_stats) {
        ...
        if ($row_stats['hit_agent_type'] == 'unknown') {	// We have a column for unknown agent type:
            $hit_key = $row_stats['hit_agent_type'];
        } elseif (isset($hits[$row_stats['hit_type'] . '_' . $row_stats['hit_agent_type']])) {	// We have a column for this narrow type:
            $hit_key = $row_stats['hit_type'] . '_' . $row_stats['hit_agent_type'];
        } elseif (isset($hits[$row_stats['hit_type']])) {	// We have a column for this broad type:
