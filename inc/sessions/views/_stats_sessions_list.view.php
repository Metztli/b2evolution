...
if ($edited_User->ID != $current_User->ID && ! $current_User->can_moderate_user($edited_User->ID)) { // Check permission:
...
if (empty($user_ID)) { // display only this user sessions in user tab
