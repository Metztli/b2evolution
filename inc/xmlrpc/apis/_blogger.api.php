...
$bloggernewpost_sig = [[$xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcBoolean]];
/**
...
function blogger_newpost($m)
{
     ...
     * @var Blog
     */
    if (! ($Collection = $Blog = &xmlrpcs_get_Blog($m, 1))) {	// Login failed, return (last) error:
        return xmlrpcs_resperror();
    }
...
$bloggereditpost_sig = [[$xmlrpcBoolean, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcBoolean]];
/**
...
$bloggerdeletepost_sig = [
    [$xmlrpcBoolean, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcBoolean],
    [$xmlrpcBoolean, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcString],
];
/**
...
$bloggergetusersblogs_sig = [[$xmlrpcArray, $xmlrpcString, $xmlrpcString, $xmlrpcString]];
/**
...
$bloggergetuserinfo_sig = [[$xmlrpcStruct, $xmlrpcString, $xmlrpcString, $xmlrpcString]];
/**
...
$bloggergetpost_sig = [[$xmlrpcStruct, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcString]];
/**
...
$bloggergetrecentposts_sig = [[$xmlrpcArray, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcString, $xmlrpcInt]];
/**
