    ...
    switch ($perm) {
        ...
        case 'admin':
            ...
            if (empty($admins_can_manipulate_sensitive_files)) {
                $r = get_icon('file_not_allowed', 'imgtag', [
                    'title' => T_('Not allowed'),
                ]);
            } else {
...
$highlight_fadeout = empty($fadeout_id) ? [] : [
    'ftyp_ID' => [$fadeout_id],
];
