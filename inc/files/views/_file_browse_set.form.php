...
$Form->radio_input('option_showdate', $UserSettings->get('fm_showdate'), [
    [
        'value' => 'no',
        'label' => TB_('No'),
    ],
    [
        'value' => 'compact',
        'label' => TB_('Smart date format'),
    ],
    [
        'value' => 'long',
        'label' => TB_('Long format'),
    ]], TB_('Last change'));
$Form->checklist([
    ['option_showfsperms', 1, TB_('Unix file permissions'), $UserSettings->get('fm_showfsperms')],
    ['option_permlikelsl', 1, TB_('Check to display file permissions like "rwxr-xr-x" rather than short form'), $UserSettings->get('fm_permlikelsl')],
...
$Form->checklist([
    ['option_showhidden', 1, TB_('Check this to show system hidden files. System hidden files start with a dot (.)'), $UserSettings->get('fm_showhidden')],
    ['option_showevocache', 1, TB_('Check this to show _evocache folders (not recommended)'), $UserSettings->get('fm_showevocache')],
...
$Form->radio_input('option_allowfiltering', $UserSettings->get('fm_allowfiltering'), [
    [
        'value' => 'no',
        'label' => TB_('Don\'t show'),
    ],
    [
        'value' => 'simple',
        'label' => TB_('Simple'),
    ...
    [
        'value' => 'regexp',
        'label' => TB_('With regular expressions'),
    ]], TB_('Filter box'));
$Form->end_fieldset();
...
$Form->end_form([['submit', 'actionArray[update_settings]', TB_('Save Changes!'), 'SaveButton']]);
